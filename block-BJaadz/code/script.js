...
// Change the background of all the hr to "antiquewhite" using for of loop.
 for(let hr of allHrs){
    allHrs.style.background = "antiquewhite";
 }
...
par.innerText = "querySelector returns an element you can maupulate but querySelectorAll returns the collection of elements in array kind of structure.";
...
let box2 = document.querySelector("box 2");
  box2.append("para","Append inserts as last child");
// Select box 3 and prepend a new paragraph element with content "Prepend inserts as first child" just before hr element.
 let box3 = document.querySelector("box 2");
 box2.prepend("para","Prepend inserts as first child");
...
// Change the font size of the para inside box 1 to 0.8rem.
  let box1para = document.querySelector("para");
  box1para.style.fontSize = "0.8rem";
...
let imgElem = document.createElement("image");
...
// Change the placeholder property of the input element to "Enter you email!"
 let placeholder = document.querySelector("input[type="placeholder"]");
